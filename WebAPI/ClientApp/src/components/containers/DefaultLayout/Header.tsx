                ...
                <Container maxWidth="xl">
                    <Toolbar style={{ paddingLeft: 0, paddingRight: 0 }}>
                        ...
                        {(!isAuth) ?
                            ...
                            >
                                {(user.image == null) ? <Avatar sx={{ width: 32, height: 32, color: "#55FCF1", border: 2, borderColor: '#45A29E' }} style={{ backgroundColor: "transparent" }}>{user.name[0]}</Avatar> : <Avatar alt="Image" sx={{ width: 32, height: 32 }} src={user.image} />}
                            </IconButton>)}
